...
> If (p>5), (deg Qle5), and the homogeneous quintic part is rank one,
> [
> Q_5=lambda L^5,
> ]
...
- the very large degree-3 cubic branch had been reduced case-by-case and treated as eliminated in the working proof;
